...
urlpatterns = [
    ...
    path('relatorio/partidas-gerado/', views.partidas_gerado_view, name='partidas_gerado_view'),
    path('relatorio/chegadas-gerado/', views.chegadas_gerado_view, name='chegadas_gerado_view'),
